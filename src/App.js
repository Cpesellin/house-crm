  ...
  <div class="inv-wrap" style="font-family:'DM Sans',sans-serif;min-height:100vh">
    ...
    <div id="invHeader" style="background:linear-gradient(170deg,#122d4f 0%,#1a4f8b 40%,#2563a8 100%);padding:14px 16px 16px;position:relative;overflow:hidden">
      ...
      <div style="position:relative;z-index:1">
        <div class="inv-h-titulo" style="font-family:'Fraunces',serif;font-size:22px;font-weight:800;color:#fff;line-height:1.1;margin-bottom:3px">Portafolio disponible</div>
        <div class="inv-h-sub" style="font-size:12px;color:rgba(255,255,255,.4)">Encuentra el inmueble perfecto para ti</div>
        <div class="inv-h-stats" style="display:flex;gap:6px;margin-top:14px">
          <div class="inv-h-stat" style="flex:1;background:rgba(255,255,255,.06);border-radius:10;padding:8px 0;text-align:center;border:1px solid rgba(255,255,255,.06)"><div id="hst2" class="inv-h-n" style="font-size:20px;font-weight:800;color:#fff">0</div><div class="inv-h-l" style="font-size:9px;color:rgba(255,255,255,.35);font-weight:700;letter-spacing:.5px;text-transform:uppercase">Total</div></div>
          <div class="inv-h-stat" style="flex:1;background:rgba(52,211,153,.1);border-radius:10;padding:8px 0;text-align:center;border:1px solid rgba(52,211,153,.06)"><div id="hsv2" class="inv-h-n" style="font-size:20px;font-weight:800;color:#34d399">0</div><div class="inv-h-l" style="font-size:9px;color:rgba(255,255,255,.35);font-weight:700;letter-spacing:.5px;text-transform:uppercase">Venta</div></div>
          <div class="inv-h-stat" style="flex:1;background:rgba(251,191,36,.1);border-radius:10;padding:8px 0;text-align:center;border:1px solid rgba(251,191,36,.06)"><div id="hsa2" class="inv-h-n" style="font-size:20px;font-weight:800;color:#fbbf24">0</div><div class="inv-h-l" style="font-size:9px;color:rgba(255,255,255,.35);font-weight:700;letter-spacing:.5px;text-transform:uppercase">Arriendo</div></div>
          <div class="inv-h-stat" style="flex:1;background:rgba(167,139,250,.12);border-radius:10;padding:8px 0;text-align:center;border:1px solid rgba(167,139,250,.06)"><div id="hsb2" class="inv-h-n" style="font-size:20px;font-weight:800;color:#a78bfa">0</div><div class="inv-h-l" style="font-size:9px;color:rgba(255,255,255,.35);font-weight:700;letter-spacing:.5px;text-transform:uppercase">Ambas</div></div>
        </div>
      </div>
    </div>
