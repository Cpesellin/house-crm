...
<div class="sec act" id="sec-inv">
  <div class="hero"><div class="hin"><div><h1>Portafolio <em>disponible</em></h1><p>Inmuebles activos \u00B7 Tiempo real</p></div><div class="sr"><div class="st"><div class="stn" id="hst">\u2014</div><div class="stl">Total</div></div><div class="st"><div class="stn" id="hsv">\u2014</div><div class="stl">Venta</div></div><div class="st"><div class="stn" id="hsa">\u2014</div><div class="stl">Arriendo</div></div><div class="st"><div class="stn" id="hsb">\u2014</div><div class="stl">Ambas</div></div></div></div></div>
  <div style="max-width:1300px;margin:0 auto;padding:10px 14px 60px">
    ...
    <div style="display:flex;gap:6px;margin-bottom:8px;flex-wrap:wrap;align-items:center">
      <button class="my-toggle" id="myToggle" onclick="toggleMis()">\u{1F3E0} Mis inmuebles</button>
    ...
    <div class="card"><div class="cdh"><div class="chl"><div class="chi">\u2699\uFE0F</div><div><div class="cht">Filtros</div></div></div><button class="bt bsm bd" onclick="limpiar()">\u2715 Limpiar</button></div><div class="cdb"><div class="fg">
      ...
      <div class="slb"><div class="slt"><span class="sltt">\u{1F511} Arriendo/mes</span><span class="rp off" id="arp">Sin filtro</span></div><div class="drs"><div class="drbg"></div><div class="drf" id="arf"></div><input id="arlo" class="dri lo" type="range" min="0" max="20" value="0"><input id="arhi" class="dri hi" type="range" min="0" max="20" value="20"></div><div class="drtk"><span>$0</span><span>$2.5M</span><span>$5M</span><span>$7.5M</span><span>$10M</span></div></div>
      <div class="slb"><div class="slt"><span class="sltt">\u{1F4B0} Venta</span><span class="rp gr off" id="vnp">Sin filtro</span></div><div class="drs"><div class="drbg"></div><div class="drf gf" id="vnf"></div><input id="vnlo" class="dri lo gi" type="range" min="0" max="57" value="0"><input id="vnhi" class="dri hi gi" type="range" min="0" max="57" value="57"></div><div class="drtk"><span>$150M</span><span>$1.000M</span><span>$2.000M</span><span>$3.000M</span></div></div>
    </div>
    <div id="selbar" style="display:none;margin-top:10px;background:linear-gradient(135deg,var(--b50),var(--cd2));border:1.5px solid var(--b200);border-radius:8px;padding:10px"><div style="font-size:8px;font-weight:800;letter-spacing:1.5px;text-transform:uppercase;color:var(--b600);margin-bottom:6px">\u2726 Lo que seleccionaste</div><div id="seltags" style="display:flex;flex-wrap:wrap;gap:4px"></div></div>
    <div class="br"><button class="bt bp" onclick="doSearch()">\u{1F50D} Buscar</button><button class="bt bs2" onclick="mostrarTodo()">Todos</button><button class="bt bd" onclick="limpiar()">\u2715</button></div></div></div>
    <div id="res"></div>
  </div>
</div>
