...
function renderPanel(name) {
  ...
  if (name === 'neg') {
    ...
    if (showVnt) {
      h += `<div><div style="font-size:15px;font-weight:800;color:#2c2520;margin-bottom:10px">🏦 Precio venta</div><div style="display:flex;gap:8px;align-items:center"><div style="flex:1"><div style="font-size:9px;color:#8b8178;font-weight:700;margin-bottom:3px;text-transform:uppercase;letter-spacing:.8px">Desde</div><div class="precio-input" style="border:1.5px solid rgba(5,150,105,.15)"><span style="font-size:13px;color:#059669;font-weight:800">$</span><input id="vnMin" placeholder="100.000.000" inputmode="numeric" oninput="fmtPrice(this)" onblur="autoHasta('vnMin','vnMax','vnt')" value="${document.getElementById('vnMin')?.value||''}"></div></div><span style="color:#d4cdc4;font-weight:800;margin-top:16px">—</span><div style="flex:1"><div style="font-size:9px;color:#8b8178;font-weight:700;margin-bottom:3px;text-transform:uppercase;letter-spacing:.8px">Hasta</div><div class="precio-input" style="border:1.5px solid rgba(5,150,105,.15)"><span style="font-size:13px;color:#059669;font-weight:800">$</span><input id="vnMax" placeholder="3.000.000.000" inputmode="numeric" oninput="fmtPrice(this)" value="${document.getElementById('vnMax')?.value||''}"></div></div></div></div>`;
    }
